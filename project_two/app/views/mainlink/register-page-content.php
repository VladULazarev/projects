 ...
 *
 * @link https://domainename.com/register
 *
 * Contains all data we see on the Register page between <main></main> html tags
 */
     ...
     <div class="col-lg-4">
       ...
       <form class="register">
         ...
         <div class="btn-container mt-3">
             <button class="btn-default btn-register">Register</button>
         </div>
